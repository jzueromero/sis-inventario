...
<html class="fixed">
	...
	<body>
		<section class="body">
			...
			<!-- start: header -->
		<?php
			include('phpPage/barrasuperior.php');
		?>
			<!-- end: header -->
					...
					<!-- start: page -->
						...
						<section class="panel">
							<header class="panel-heading">
                                ...
                                <button class="btn btn-primary " onclick="location.href = 'sis_usuarios_crud.php?option=nuevo';">Crear Nuevo Usuario</button>
                                </div>
                            </header>
									...
									<table class="table table-bordered table-striped table-condensed mb-none">
										...
										<tbody>
                                            ...
                                            if($registros>0)
                                            {
                                                ...
                                                <td class="text-left"><a href="sis_usuarios_crud.php?opcion=EDITAR&codigo='.$fila['idusuarios'].'" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                                <label for="      " ></label>
												<a href="sis_usuarios_crud.php?opcion=BORRAR&codigo='.$fila['idusuarios'].'" class="on-default remove-row"><i class="fa fa-trash-o"></i></a></td>
											</tr>
                                                    ';
                                                }
