<?php
    ...
    if(isset($_POST['CREAR']))
    {
		...
		if($filas > 0)
		{
			echo "<script>
					...
					window.location = 'sis_unidades.php';
				</script>";
		}
		else 
		{
			$sqlusuario = "INSERT INTO unidades(nombre) 
						values('$nombre')";
    ...
    if(isset($_POST['EDITAR']))
    {
        ...
        $sqluser = "";
            ...
            $sqluser = "update  unidades set nombre = '$nombre' where id = '$codigo'";
    ...
    if(isset($_POST['BORRAR']))
    {
        ...
        $sqluser = "DELETE FROM unidades where id = '$codigo'";
							...
							<form id="form" action="<?php $_SERVER["PHP_SELF"]; ?>" method="POST" class="form-horizontal">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title"><?php echo $valor; ?> - Gestion Unidades</h2>
										<p class="panel-subtitle">
											Favor proporcionar la informacion solicitada para las Unidades.
										</p>
									</header>
									<div class="panel-body">
                                        ...
                                        <div class="form-group">
											...
											<div class="col-sm-9">
												<input <?php echo $SoloLectura; ?> type="text" name="nombre" value="<?php echo $nombre ?>" class="form-control" placeholder="eg.: Sobre, Libra, Caja" required/>
											</div>
										</div>
